         ...
         function(
             ...
             return Backbone.View.extend({
                 ...
                 postRender: function() {
                     ...
                     if (this.entitlement) {
                         curSession = _.findWhere(this.model.get('course_runs'), {is_enrolled: true});
                         this.sessionSelectionView = new EntitlementView({
                             el: this.$('#course-' + courseUUID + ' .course-entitlement-selection-container'),
                             $parentEl: this.$el,
                             ...
                             courseCardMessages: '',
                             courseImageLink: '',
                             courseTitleLink: '.course-details .course-title',
                             dateDisplayField: '.course-details .course-text',
                             enterCourseBtn: '',
                             availableSessions: JSON.stringify(this.model.get('course_runs')),
                             entitlementUUID: this.entitlement.uuid,
                             currentSessionId: curSession ? curSession.key : '',
                             enrollUrl: this.model.get('enroll_url'),
                             courseHomeUrl: curSession ? curSession.course_url : ''
                          });
                     }
